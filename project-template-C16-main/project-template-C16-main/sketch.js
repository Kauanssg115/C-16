...
function setup() {
 ...
 //Crie um grupo para pinkBalloon (balão rosa)
  ...
  //Crie um grupo para redBallon (balão vermelho)
...
if(arrow.isTouching(greenBalloonGroup)){
...
if(arrow.isTouching(blueBalloonGroup)){
...
if(arrow.isTouching(pinkBalloonGroup)){
  pinkBalloonGroup.destroyEach
  arrowGroup.destroyEach
}
if(arrow.isTouching(redBalloonGroup)){
